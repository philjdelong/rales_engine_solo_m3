...
RSpec.describe "Customers API" do
  describe "business logic" do
    it "sends the top merchant" do
      ...
      invoice_3 = create(:invoice, id: 3, customer_id: 1, merchant_id: 2)
      invoice_4 = create(:invoice, id: 4, customer_id: 2, merchant_id: 2)
      ...
      expect(favorite_merchant["attributes"]["id"]).to eq(2)
